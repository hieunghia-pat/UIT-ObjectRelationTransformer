...
if __name__ == "__main__":
  ...
  # input json
  parser.add_argument('--input_json', default='data/dataset_uitviic.json', help='input json file to process into hdf5')
  parser.add_argument('--dict_json', default='data/uitviictalk.json', help='output json file')
  parser.add_argument('--output_pkl', default='data/uitviic-all', help='output pickle file')
